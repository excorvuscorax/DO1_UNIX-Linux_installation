...
- Получение IP-адреса устройства, с которым работаем, от DHCP-сервера.
	...
	![](src/screen/20251221221333.png)	
	
	Запрашиваем новый ip от сервера:
	![](src/screen/20251222001205.png)
...
![](src/screen/20251224160921.png)

- После обновления системных пакетов, снова введем команду обновления, должно появиться сообщение об отсутствии обновлений:
![](src/screen/20251224163317.png)

## Часть 5. Использование команды **sudo**

- Разрешить пользователю, созданному в [части 2](https://platform.21-school.ru/project/26557/task#part-2-creating-a-user) , выполнять команду sudo.
	![](src/screen/20251224164210.png)
...
- Настройка службы автоматической синхронизации времени
	...
	![](src/screen/20251231102918.png)
	
	Проверим работоспособность синхронизации:
	![](src/screen/20251231105538.png)
...
- Создание файла _test_X.txt_ , где X — имя редактора, в котором создан файл. 
	...
	**F10** - по нажатию клавиши осуществляется выход из редактора MCEDIT
	...
	![](src/screen/20251231120126.png)
	
	Либо можно самостоятельно сохранить файл нажатием `F2`:
	![](src/screen/20251231120341.png)
...
- Используя каждый из трех выбранных редакторов, еще раз отредактируем файл (аналогично предыдущему пункту)
	...
	**Отредактируем NANO:**	![](src/screen/20251231122802.png)
...
- Запуск top
	...
	Появляется следующий вывод:	![](src/screen/20260112115906.png)
...
- Выведем размер папок (в удобочитаемом формате):
	...
	`du -sh /home`:
	![](src/screen/20260112173809.png)
	`sudo du -sh /var`:
	![](src/screen/20260112173916.png)
	
	Выведем размер всего содержимого в /var/log
	`sudo du -h /var/log`:
	![](src/screen/20260112174139.png)
...
- Установим утилиту ncdu
	...
	![](src/screen/20260112174613.png)

- Выведем размер папок 
	`ncdu /home`:
	![](src/screen/20260112175235.png)
	
	`ncdu /var`:
	![](src/screen/20260112175320.png)
	
	`ncdu /var/log`:
	![](src/screen/20260112175420.png)
...
- Открываем для просмотра:
	...
	![](src/screen/20260112180248.png)
	
	`sudo nano /var/log/syslog:`
	![](src/screen/20260112180456.png)
	
	`sudo nano /var/log/auth.log:`
	![](src/screen/20260112180731.png)
